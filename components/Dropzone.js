...
const Dropzone = () => {
    ...
    const onDropRejected = () => {
        mostrarAlerta('No se pudo subir, el lìmite es 1 MB, regístrate para subir archivos más grandes')
    }
    ...
    const { getRootProps, getInputProps, isDragActive, acceptedFiles } = useDropzone({onDrop, onDropRejected, maxSize: 1000000});
